/*
 * usb_descriptors.c: USB Device descriptors for rp2350-device-freertos.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x407A   (TinyUSB educational VID + project PID)
 *   Manufacturer string github.com/sauloverissimo
 *   Product string      RP2350FreeRTOSBench
 *
 * Configuration:
 *   1 MIDI 2.0 class interface (Audio Control + MIDI Streaming, Alt 0 + Alt 1),
 *   one bidirectional Function Block, firstGroup=0, numGroups=1.
 */
#include <string.h>
