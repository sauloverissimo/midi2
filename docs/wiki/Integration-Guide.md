...
In the IDE, search `midi2` in the Library Manager and click Install. Reference sketches appear under **File > Examples > midi2**: `teensy-device-midi2`, a complete USB MIDI 2.0 device for Teensy 4.x, and `atmega32u4-device-arduino`, the same device role on the Arduino Leonardo over the midi2duino transport. Sketch include:
...
```cmake
if(NOT TARGET midi2)
  find_package(midi2 0.8.0 QUIET CONFIG)
  if(NOT midi2_FOUND)
...
midi2/
  ...
  test/     383 tests across 8 suites
```
