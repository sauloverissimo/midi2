...
| PlatformIO | `lib_deps = sauloverissimo/midi2 @ ^0.10.0` |
| ESP-IDF | `sauloverissimo/midi2: ">=0.10.0"` in `idf_component.yml` |
| Zephyr | west manifest entry + `CONFIG_MIDI2=y` (see Integration Guide) |
| CMake | `FetchContent_Declare(midi2 GIT_TAG v0.10.0)` |
